...
import info.mschmitt.ak.runtime.MethodDispatcher;
import info.mschmitt.ak.runtime.MethodPerformer;
import info.mschmitt.ak.runtime.MethodSignatureService;
...
public class FoundationGuiceModule extends FoundationModule implements Module {
    ...
    @Provides
    @Singleton
    public MessagePortFactory provideMessagePortFactory(PortMessageFactory portMessageFactory, MachPortFactory machPortFactory) {
        return super.provideMessagePortFactory(portMessageFactory, machPortFactory);
    }
